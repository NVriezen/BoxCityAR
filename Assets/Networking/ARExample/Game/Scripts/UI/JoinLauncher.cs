...
{
	public class JoinLauncher : MonoBehaviourPunCallbacks
	{
        ...
        [Tooltip("The UI Panel to inform the user of the available rooms")]
        [SerializeField]
        private GameObject roomsList;

        [Tooltip("The UI Panel to inform the user of the player in the room")]
        [SerializeField]
  ...
  //          } else {
        ...
        public static void SetRoom(string selectedRoom)
        {
