namespace GoogleARCore.Examples.CloudAnchors
{
	...
	/// </summary>
	public class CloudAnchorControllerBoxcity : MonoBehaviour
	{
		/// <summary>
		...
		public void Update()
		{
			...
			if (Application.platform != RuntimePlatform.IPhonePlayer)
			{
					...
					TrackableHitFlags.PlaneWithinPolygon, out hit))
				{
					...
					OnJoinedInstantiate.anchor_placed_ = true;
				}
			}
			else
			{
		...
		public bool GetLastPlacedAnchor(){
			if (m_LastPlacedAnchor != null)
				return true;
			return false;
		}

		public bool GetLastResolvedAnchor(){
		...
		private void _ResetStatus()
		{
			...
			if (m_LastPlacedAnchor != null)
			{
				...
				OnJoinedInstantiate.anchor_placed_ = false;
			}
